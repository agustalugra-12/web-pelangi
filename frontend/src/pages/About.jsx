        ...
        <div className="mt-14 grid md:grid-cols-2 gap-10 items-center">
          <div className="grid grid-cols-2 gap-3">
            <div className="aspect-[3/4] rounded-3xl overflow-hidden shadow-paper-sm">
              <img src={byCat(gallery, "Lobby").src} alt={site.brand} className="w-full h-full object-cover" loading="lazy" />
            </div>
            <div className="aspect-[3/4] rounded-3xl overflow-hidden shadow-paper-sm mt-8">
              <img src={byCat(gallery, "Restaurant").src} alt={`${site.brand} Restaurant`} className="w-full h-full object-cover" loading="lazy" />
            </div>
          </div>
