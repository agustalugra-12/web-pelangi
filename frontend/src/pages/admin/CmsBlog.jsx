    ...
    <div className="max-w-5xl">
      ...
      {stats && (
        <div className="bg-paper rounded-2xl border border-ink/10 p-5 mb-6 grid grid-cols-2 md:grid-cols-4 gap-4" data-testid="seo-agent-stats">
          ...
          {(stats.last_generated_title || stats.keyword_dilewati_mirip > 0 || stats.keyword_gagal_berulang > 0 || stats.keyword_ditolak_tipe_properti_salah > 0 || stats.keyword_ditolak_angle_entity_salah > 0 || stats.usage_cost_today_total > 0) && (
            <div className="col-span-2 md:col-span-4 pt-2 border-t border-ink/10 text-sm text-teal-deep/70 space-y-1">
              ...
              {stats.keyword_ditolak_angle_entity_salah > 0 && (
                <p title="Keyword yang angle-nya (mis. 'Pasangan'/'Day Use'/'Booking') tidak masuk akal untuk tempat pihak ketiga yang dibicarakan (mis. masjid, kantor polisi) - ditolak SEBELUM ditulis, mencegah artikel dengan sudut pandang yang tidak masuk akal.">
                  {stats.keyword_ditolak_angle_entity_salah} keyword ditolak otomatis (sudut pandang tidak sesuai jenis tempat)
                </p>
              )}
